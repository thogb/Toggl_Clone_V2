...
export const ProjectFilterButton = (props) => {
    return (
...
export default function ProjectFilter({
  ...
  onComplete,
    ...
    const projects = useSelector((state) => state.projects.projects)[workspaceId] ?? [];
  ...
  return (
    ...
    triggerComponent={<ProjectFilterButton onClick={(e) => setPopperAnchorEl(e.currentTarget)} />}
    >
        <ListFilter
        ...
        <TTPopperActionSection>
            <SubjectStateFilter subjectStates={Object.values(PROJECT_STATE)} currentSubjectState={PROJECT_STATE.active}/>
        </TTPopperActionSection>
    </TTPopper>
  )
}
